...
@section('title', 'Yeni Depolama Ekle - Admin Panel')
@section('page-title', 'Yeni Depolama Ekle')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Depolama Bilgileri</h3>
        </div>
        
        <form method="POST" action="{{ route('admin.data.storages.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div class="flex items-center">
                ...
                <label for="is_active" class="ml-2 text-sm text-gray-700">
                    <i class="fas fa-check mr-1"></i>Aktif depolama olarak işaretle
                </label>
            </div>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Depolamayı Kaydet
                </button>
            </div>
        </form>
    </div>
