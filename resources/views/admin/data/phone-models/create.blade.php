...
@section('title', 'Yeni Telefon Modeli Ekle - Admin Panel')
@section('page-title', 'Yeni Telefon Modeli Ekle')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Telefon Modeli Bilgileri</h3>
        </div>
        
        <form method="POST" action="{{ route('admin.data.phone-models.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea id="description" 
                          ...
                          placeholder="Model hakkında kısa açıklama...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Modeli Kaydet
                </button>
            </div>
        </form>
    </div>
